...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <!-- SEO Meta Tags -->
        <meta name="description" content="@yield('description', 'Track congressional bills, executive orders, and legislative activity in real-time. Stay informed about what\'s happening in Congress with GovTrack.Live.')">
        <meta name="keywords" content="@yield('keywords', 'congress, bills, legislation, executive orders, government, politics, tracking, democracy, transparency')">
        ...
        <meta property="og:title" content="@yield('og_title','GovTrack.Live - Legislative Oversight & Transparency')">
        <meta property="og:description" content="@yield('og_description', 'Track congressional bills, executive orders, and legislative activity in real-time.')">
